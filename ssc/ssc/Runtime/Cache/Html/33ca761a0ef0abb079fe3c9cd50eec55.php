<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    *{ padding: 0; margin: 0; }
    ...
    .message{width: 600px;height: 450px;margin:auto;border:1px solid #1B8F24;margin-top: 30px;}
    ...
    .jump{text-align: center;margin-top:80px; font-size:18px;}.
    </style>
    ...
    等待时间： <b id="wait" style="margin-top:80px; font-size:18px;"><?php echo($waitSecond); ?></b>
