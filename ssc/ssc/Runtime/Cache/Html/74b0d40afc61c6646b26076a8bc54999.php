...
<body>
    ...
    <div class="lottery_wrap">
      <div class="lottery_top clearfix">
        <div class="gm_con">
          <div class="gm_logo cqssc"> 
          <div class="wfqh">
          		<a href="javascript:void(0);">官方玩法<i></i></a>
          		<a href="javascript:void(0);" onClick="$('#ym-center').load('<?php echo U('Html/Category/ssccqmj');?>');" >民间玩法</a>
          	</div>
             </div>
        </div>
        <div class="gct_l">
...
<!--          <div id="countdown_knob" class="timerArea" ></div>-->
      ...
      <div class="gm_con_r fr">
        ...
        <div class="tb_list tb_list1 clearfix tzjilu" style="display: block;">
         ...
         <ul> 
        <?php if(is_array($betRecord)): $i = 0; $__LIST__ = $betRecord;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$betRecord): $mod = ($i % 2 );++$i;?><li> <span><?php echo ($betRecord["catename"]); ?></span><span><?php echo ($betRecord["issue"]); ?></span><span><?php echo ($betRecord["content"]); ?></span><span><?php echo ($betRecord["profitLoss"]); ?></span> </li><?php endforeach; endif; else: echo "" ;endif; ?>
         </ul>
        ...
        <div class="tb_list tb_list3 tb_list_2 clearfix">
          ...
          <!-- 传参-->
			<div class="more_r"><a target="view_window" href="<?php echo U('Index/hmzst',array('id'=>2,code=>5));?>">更多</a><i></i></div>
        </div>
        <div class="bet_divbg">
...
<div class="alert-box" id="tk02" style="display:none;">
  <div class="alert">
    <div class="alert-title1">
      <div class="alert-logo"><i><img src="/Public/Html/images/cqssc.png"></i></div>
...
<script src="/Public/Html/js/face/face.ssccq.js"></script>
<script src="/Public/Html/js/methods/methods.ssccq.js"></script>
<script src="/Public/Html/js/game/jquery.game.ssccq.js"></script>
<script>
       ...
       // var pri_lastopen  = jsonobj=eval("("+$('#pri_lastopen').html()+")");
        ...
        var pri_ajaxurl   = "<?php echo U('Html/Category/receive_and_return');?>";
...
$.ajax({
                cache: true,
                type: "POST",
                url:'<?php echo U('Html/Category/ssccp_openData');?>',
                data:"cate_id="+pri_lotteryid,
                async: false,
                dataType: 'json',
...
var  list3Data = function () {
		$.ajax({
			type: "POST",
			url: "<?php echo U('Html/Category/cqssc_open_code');?>",
			data: "tb_list3",
			timeout: 9000,
            dataType: 'json',
			success: function (data) {
                	...
                	console.log(data);
        var list3="";
				for(var i=0;i<data.cqssc_open_code.length;i++){
					 list3 += '<li><span style="width:50%;">'+data.cqssc_open_code[i].expect+'</span><span style="width:50%;">'+data.cqssc_open_code[i].opencode+'</span></li>';
				}
...
<script src="/Public/Html/lib/jquery.countdown.js"></script>
