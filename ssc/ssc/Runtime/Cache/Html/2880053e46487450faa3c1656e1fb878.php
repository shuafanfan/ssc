      ...
      <div class="lottery_top clearfix">
        <div class="gm_con">
          ...
          <div class="wfqh">
          		...
          		<a href="javascript:void(0);" onClick="$('#ym-center').load('<?php echo U('Html/Category/ssctjmj');?>');" >民间玩法</a>
          	</div>
            </div>
        </div>
        <div class="gct_l">
      ...
      <div class="gm_con_r fr">
        ...
        <div class="tb_list tb_list3 tb_list_2 clearfix">
          ...
          <ul>
			...
			<div class="more_r"><a target="view_window" href="<?php echo U('Index/hmzst',array('id'=>4,code=>5));?>">更多</a><i></i></div>
        </div>
        <div class="bet_divbg">
...
<div class="alert-box" id="tk02" style="display:none;">
  <div class="alert">
    <div class="alert-title1">
      <div class="alert-logo"><i><img src="/Public/Html/images/tjssc"></i></div>
...
<script src="/Public/Html/js/face/face.ssctj.js"></script>
<script src="/Public/Html/js/methods/methods.ssctj.js"></script>
<script src="/Public/Html/js/game/jquery.game.ssctj.js"></script>
<script>
       ...
       // var pri_lastopen  = jsonobj=eval("("+$('#pri_lastopen').html()+")");
        ...
        var pri_ajaxurl   = "<?php echo U('Html/Tianjinforever/tjssc_return');?>";
 ...
 $.ajax({
                cache: true,
                type: "POST",
                url:'<?php echo U('Html/Tianjinforever/tjssc_openData');?>',
                data:{'money':1},
                async: false,
                dataType: 'json',
...
var  list3Data = function () {
		$.ajax({
			type: "POST",
			url: "<?php echo U('Html/Tianjinforever/tianjinforever_open_code');?>",
			data: "tb_list3",
			timeout: 9000,
            dataType: 'json',
			success: function (data) {
        var list3="";
				for(var i=0;i<data.tianjinforever_open_code.length;i++){
					 list3 += '<li><span style="width:50%;">'+data.tianjinforever_open_code[i].expect+'</span><span style="width:50%;">'+data.tianjinforever_open_code[i].opencode+'</span></li>';
				}
