(function (g) {
	...
	function m(p) {
		...
		var o = '<div class=mdl style="width:' + p.width + 'px;"><div class="layui-layer-title" >' + p.title + '</div><table style="width:100%;"><tr><td ' + (p.ismsgcenter ? 'style="text-align:center;"' : "") + ">" + p.msg + "</td></tr>";
		if (p.isbottom) {
		...
		o += '<div id="block_close" class=mdl_clo></div>';
		return o
	}
	g.blockUI.defaults = {
