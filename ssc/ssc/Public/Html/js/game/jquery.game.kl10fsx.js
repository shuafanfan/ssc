		...
		$($.lt_id_data.id_sel_insert).unbind("click").click(function () {
			...
			if (zipConFlag) {
				...
				my_lzma.compress(code01, compression_mode, function (result) {
					...
					cfhtml.push('<span class="span01">' + ($.lt_method_data.title + "_" + $.lt_method_data.name) + '</span>');
					...
					$(".span06", $cfhtml).attr("title", lot_lang.dec_s24).click(function () {
						...
						$(this).parent().remove();
						if ($.lt_total_nums == 0) {
							$($.lt_id_data.id_cf_content).append('');
						}
						$($.lt_id_data.id_cf_num).html($.lt_total_nums);
						$($.lt_id_data.id_cf_money).html($.lt_total_money);
						$($.lt_id_data.id_cf_count).html(parseInt($($.lt_id_data.id_cf_count).html(), 10) - 1);
		...
		if ($.lt_time_leave <= 0) {
			...
			$.ajax({
				...
				success: function (data) {
					...
					$('#showcodebox').html('<span class="gr_s gr_sx" flag="normal">x</span><span class="gr_s gr_sx" flag="normal">x</span><span class="gr_s gr_sx" flag="normal">x</span><span class="gr_s gr_sx" flag="normal">x</span><span class="gr_s gr_sx" flag="normal">x</span><span class="gr_s gr_sx" flag="normal">x</span><span class="gr_s gr_sx" flag="normal">x</span><span class="gr_s gr_sx" flag="normal">x</span>');
