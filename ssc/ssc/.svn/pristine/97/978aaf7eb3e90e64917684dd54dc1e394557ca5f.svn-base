...
class TianjinforeverController  extends CommonController {
    
    /**
     * lotteryid:4&flag:mjwf
     */
    public function return_tianjinforever_mj() {
