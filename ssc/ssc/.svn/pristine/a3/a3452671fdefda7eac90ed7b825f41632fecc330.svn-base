...
function(a) {
    ...
    b.o = function() {
        ...
        this._touch = function(a) {
            ...
            d(a),
            b.c.d.bind("touchmove.k", d).bind("touchend.k",
            function() {
        ...
        this._mouse = function(a) {
            ...
            return d(a),
            b.c.d.bind("mousemove.k", d).bind("keyup.k",
            function(a) {
                if (27 === a.keyCode) {
    ...
    b.Dial = function() {
        ...
        this.val = function(a) {
            $(".wheel_span_bf").text(Math.abs((fsbf-(a<0?0:(a>100?100:a))*fsbfbili).toFixed(1)));
            $(".wheel_span_jj").text(((a<0?0:(a>100?100:a))*bili+fsxiao).toFixed(1));
            $(".wheel_span_pl").text((((a<0?0:(a>100?100:a))*bili+fsxiao)/2).toFixed(1));
        ...
        this.listen = function() {
            ...
            e = function(a) {
                ...
                d = c.detail || c.wheelDeltaX,
                e = c.detail || c.wheelDeltaY,
                f = parseInt(b.$.val()) + (d > 0 || e > 0 ? b.o.step: 0 > d || 0 > e ? -b.o.step: 0);
                b.cH && b.cH(f) === !1 || b.val(f)
            },
            h = 1,
            i = {
                37 : -b.o.step,
            ...
            function(e) {
                var j = e.keyCode;
                if (j >= 96 && 105 >= j && (j = e.keyCode = j - 48), f = parseInt(String.fromCharCode(j)), isNaN(f) && (13 !== j && 8 !== j && 9 !== j && 189 !== j && e.preventDefault(), a.inArray(j, [37, 38, 39, 40]) > -1)) {
                    e.preventDefault();
                    var k = parseInt(b.$.val()) + i[j] * h;
                    b.o.stopper && (k = c(d(k, b.o.max), b.o.min)),
                    b.change(k),
                    b._draw(),
            ...
            function() {
                isNaN(f) ? g && (window.clearTimeout(g), g = null, h = 1, b.val(b.$.val())) : b.$.val() > b.o.max && b.$.val(b.o.max) || b.$.val() < b.o.min && b.$.val(b.o.min)
            }),
        ...
        this.init = function() { (this.v < this.o.min || this.v > this.o.max) && (this.v = this.o.min),
            ...
            this.o.displayInput && this.i.css({
                ...
                border: 0,
                background: "none",
                font: "600 " + (this.o.width / a >> 0) + "px 'Source Sans Pro', Arial",
                "text-align": "center",
        ...
        this.change = function(a) {
            this.cv = a,
            this.$.val(a);
            $(".wheel_span_bf").text(Math.abs((fsbf-a*fsbfbili).toFixed(1)));
            $(".wheel_span_jj").text((a*bili+fsxiao).toFixed(1));
            $(".wheel_span_pl").text(((a*bili+fsxiao)/2).toFixed(1));
        ...
        this.draw = function() {
            var e, f, a = this.g,
            b = this.angle(this.cv),
            c = this.startAngle,
            d = c + b,
            g = 1;
            a.lineWidth = this.lineWidth,
            a.lineCap = this.lineCap,
            this.o.cursor && (c = d - this.cursorExt) && (d += this.cursorExt),
            a.beginPath(),
            a.strokeStyle = this.o.bgColor,
            a.arc(this.xy, this.xy, this.radius, this.endAngle, this.startAngle, !0),
            a.stroke(),
            this.o.displayPrevious && (f = this.startAngle + this.angle(this.v), e = this.startAngle, this.o.cursor && (e = f - this.cursorExt) && (f += this.cursorExt), a.beginPath(), a.strokeStyle = this.pColor, a.arc(this.xy, this.xy, this.radius, e, f, !1), a.stroke(), g = this.cv == this.v),
            a.beginPath(),
            a.strokeStyle = g ? this.o.fgColor: this.fgColor,
            a.arc(this.xy, this.xy, this.radius, c, d, !1),
            a.stroke()
        },
