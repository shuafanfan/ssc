...
class AllsscController extends Controller {
...
//        print_r($winPrize);
     ...
     * 后三、后三组合
     */
    public function backThree_hszh() {
        $openPrize = $this->judge();
        if(!empty($openPrize)){
            $opencode = $openPrize['str'];
            $opencode = substr($opencode, 4, 5);
...
//        }
    ...
    * 前三、前三组合
    */
    public function frontThree_qszh() {
        $openPrize = $this->judge();
        if(!empty($openPrize)){
            $winPrize1 = array();
            $winPrize2 = array();
            ...
            $winPrize = array_merge($another,$winPrize1,$winPrize2,$winPrize3);
        }
        return  $winPrize;
    }
    ...
    */
     ...
     * @return type
     */
    public function all_ssc_winPriz_array() {
        $five_zxfs = $this->five_zxfs();
        $five_zxds = $this->five_zxds();
        $five_wxzh = $this->five_wxzh();
        ...
        $backThree_hszh = $this->backThree_hszh();
        $inThree_hszh = $this->inThree_hszh();
        $backThree_zxhz = $this->backThree_zxhz();
        $inThree_zxhz = $this->inThree_zxhz();
        $backThree_zxkd = $this->backThree_zxkd();//28
        ...
        $inThree_zsds = $this->inThree_zsds();//33
        ...
        $inThree_tsh = $this->inThree_tsh();//47
        ...
        $frontThree_qszh = $this->frontThree_qszh();
...
//        $array_sum = array_merge_recursive($five_zxfs,$five_zxds,$five_wxzh,$five_zx120,$five_zx60,$five_zx30,$five_zx20,$five_zx10,$five_zx5,$five_yffs,$five_hscs,$five_sxbx,$five_sjfc,$four_zxhs,$four_zxds,$four_sxzh,$four_zx24,$four_zx12,$four_zx6,$four_zx4,$backThree_zxfs,$inThree_zxfs,$backThree_zxds,$inThree_zxds,$backThree_hszh,$inThree_hszh,$backThree_zxhz,$inThree_zxhz,$backThree_zxkd,$inThree_zxkd,$backThree_zsfs,$inThree_zsfs,$backThree_zsds,$inThree_zsds,$backThree_zlfs,$inThree_zlfs,$backThree_zlds,$inThree_zlds,$inThree_hhzx,$inThree_zxbd,$inThree_hzws,$inThree_zxhz1,$backThree_hhzx,$backThree_zxhz1,$backThree_zxbd,$backThree_hzws,$backThree_tsh,$inThree_tsh,$backTwo_zxfs,$backTwo_zxds,$backTwo_zxhz,$backTwo_zxkd,$backTwo_zxfs1,$backTwo_zxds1,$backTwo_zxhz1,$backTwo_zxbd1,$frontThree_xzfs,$frontThree_xzds,$frontThree_qszh,$frontThree_zxhz,$frontThree_zxkd,$frontThree_zsfs,$frontThree_zsds,$frontThree_zlfs,$frontThree_zlds,$frontThree_hhzx,$frontThree_zxhz1,$frontThree_zxbd,$frontThree_hzws,$frontThree_tsh,$frontTwo_zxfs,$frontTwo_zxds,$frontTwo_zxhz,$frontTwo_zxkd,$frontTwo_zxfs1,$frontTwo_zxds1,$frontTwo_zxhz1,$frontTwo_zxbd1,$dwd,$bdw_hsym,$bdw_qsym,$bdw_hsem,$bdw_qsem,$bdw_sxym,$bdw_sxem,$bdw_wxem,$bdw_wxsm,$dxds_qedxds,$dxds_qsdxds,$dxds_hsdxds);
        $array_sum = array($five_zxfs,$five_zxds,$five_wxzh,$five_zx120,$five_zx60,$five_zx30,$five_zx20,$five_zx10,$five_zx5,$five_yffs,$five_hscs,$five_sxbx,$five_sjfc,$four_zxhs,$four_zxds,$four_sxzh,$four_zx24,$four_zx12,$four_zx6,$four_zx4,$backThree_zxfs,$inThree_zxfs,$backThree_zxds,$inThree_zxds,$backThree_hszh,$inThree_hszh,$backThree_zxhz,$inThree_zxhz,$backThree_zxkd,$inThree_zxkd,$backThree_zsfs,$inThree_zsfs,$backThree_zsds,$inThree_zsds,$backThree_zlfs,$inThree_zlfs,$backThree_zlds,$inThree_zlds,$inThree_hhzx,$inThree_zxbd,$inThree_hzws,$inThree_zxhz1,$backThree_hhzx,$backThree_zxhz1,$backThree_zxbd,$backThree_hzws,$backThree_tsh,$inThree_tsh,$backTwo_zxfs,$backTwo_zxds,$backTwo_zxhz,$backTwo_zxkd,$backTwo_zxfs1,$backTwo_zxds1,$backTwo_zxhz1,$backTwo_zxbd1,$frontThree_xzfs,$frontThree_xzds,$frontThree_qszh,$frontThree_zxhz,$frontThree_zxkd,$frontThree_zsfs,$frontThree_zsds,$frontThree_zlfs,$frontThree_zlds,$frontThree_hhzx,$frontThree_zxhz1,$frontThree_zxbd,$frontThree_hzws,$frontThree_tsh,$frontTwo_zxfs,$frontTwo_zxds,$frontTwo_zxhz,$frontTwo_zxkd,$frontTwo_zxfs1,$frontTwo_zxds1,$frontTwo_zxhz1,$frontTwo_zxbd1,$dwd,$bdw_hsym,$bdw_qsym,$bdw_hsem,$bdw_qsem,$bdw_sxym,$bdw_sxem,$bdw_wxem,$bdw_wxsm,$dxds_qedxds,$dxds_qsdxds,$dxds_hsdxds);
        $winPrize = [];
