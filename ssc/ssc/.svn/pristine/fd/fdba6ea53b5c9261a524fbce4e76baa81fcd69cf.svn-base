...
class YunnanforeverController  extends CommonController {
    
    /**
     * lotteryid:32&flag:mjwf
     */
    public function return_yunnanforever_mj() {
