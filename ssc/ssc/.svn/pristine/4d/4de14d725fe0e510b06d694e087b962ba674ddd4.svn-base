...
class XinjiangforeverController  extends CommonController {
    
    
    /**
     * lotteryid:4&flag:mjwf
     */
    public function return_xinjiangforever_mj() {
...
//            print_r($return);exit;
    ...
    public function cqssc_status() {
        ...
        $cate_date_time_info = M('cate_date_time')->where($data)->order('timeStamp DESC  ')->find();
        ...
        $count = substr($cate_date_time_info['period'],9,2); 
