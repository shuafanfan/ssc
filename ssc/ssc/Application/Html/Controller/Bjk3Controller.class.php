...
class Bjk3Controller  extends CommonController {
    
    /**
     * lotteryid:14&flag:mjwf
     */
    public function return_bjk3_mj() {
    ...
    public function bjk3_openData() {
        ...
        foreach ($list as $k => $v) {
            if($k == 0){
                ...
                $lastOpenInfo = M('open_prize_data')->where(array('code'=>14,'expect'=>$lastIssue['period']))->find();
        ...
        $pri_issues = $_pri_lastopen.($this->issue_cqssc(14));
