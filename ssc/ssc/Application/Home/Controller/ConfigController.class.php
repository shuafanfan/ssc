 ...
 public function admin_bank_del(){
    ...
    */
    public function email_config(){
            ...
            if (IS_POST) {
               if ($_POST['MAIL_SMTPAUTH']==0) {
                    $_POST['MAIL_SMTPAUTH']=FALSE;
               }else{
                    $_POST['MAIL_SMTPAUTH']=TRUE;
               }
           }
           
                C($_POST);
                $email['MAIL_HOST']=C('MAIL_HOST');
                $email['MAIL_SMTPAUTH']=C('MAIL_SMTPAUTH');
                ...
                R('log/addLog',array('twoMenu'=>$_GET['twoMenu'],'content'=>'邮件配置成功！'));
